...
SELECT num_cadastro, nome, data_locacao, data_devolucao, titulo, ano FROM cliente, locacao, filme WHERE nome LIKE 'Matilde'
SELECT nome, nome_real, titulo FROM estrela, filme WHERE ano between '2015-01-01' and '2015-12-31'